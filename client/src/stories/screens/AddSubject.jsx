...
export const AddSubject = ({ opt, visible, setVisible, itemData, ...props }) => {
  const [formData, setFormData] = useState({
    name: opt === 'edit' ? itemData.name : '',
    describtion: opt === 'edit' ? itemData.describtion : '',
    kind: opt === 'edit' ? itemData.kind : '',
  })
  ...
  function handleSubmit(event) {
    ...
    opt === 'edit'
      ? dispatch(
          asyncCrudThunks.subjects.updateItemThunk({
            id: itemData.id,
            data: formData,
          }),
        )
      : dispatch(asyncCrudThunks.subjects.createItemThunk(formData))
  }
